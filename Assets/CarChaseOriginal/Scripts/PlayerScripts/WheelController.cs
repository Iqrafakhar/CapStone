...
public class WheelController : MonoBehaviour
{
   ...
   //private float targetAngle = 5f;
    ...
    {
        frontRight.steerAngle = Mathf.Lerp(frontRight.steerAngle, currentTurnAngle, Time.deltaTime * turnSpeed);
        frontLeft.steerAngle = Mathf.Lerp(frontLeft.steerAngle, currentTurnAngle, Time.deltaTime * turnSpeed);
    }
